...
void SteeringController::lin_steering_algorithm() {
    ...
    ROS_INFO("des_state_vel = %f, 'corrected' vel = %f", des_state_vel_, controller_speed);
    ROS_INFO("des_state_omega = %f, 'corrected' omega = %f", des_state_omega_, controller_omega);
