//Reactive commander node for STDR simulator
//Josh Roney (jpr87)
...
int main(int argc, char **argv) {
    ...
    while(ros::ok()) { // do forever
        ...
        //here if got an alarm; turn until alarm clears
        twist_cmd.linear.x=0.0; //stop moving forward
        
        //check the value of the index
	//negative index indicates alarm was to right of robot
	//positive index indicates alarm was to left of robot
	//turn away from the location of the alarm
        if(g_index > 0)
